<script lang="ts">
	import { Zap, Sparkles, Shield, GitBranch } from 'lucide-svelte';
...
<div class="min-h-screen flex">
	<!-- Left side - Branding -->
	<div class="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-primary/10 via-purple-500/5 to-background p-12 flex-col justify-between">
		<div>
			<div class="flex items-center gap-3">
				<div class="h-10 w-10 rounded-xl bg-gradient-to-br from-primary to-purple-600 flex items-center justify-center">
			...
			<div class="mt-16">
				<h1 class="text-4xl font-bold leading-tight mb-4">
					Your AI-powered<br />task execution engine
				</h1>
		...
		<p class="text-sm text-muted-foreground">
			Powered by Anthropic's Claude &bull; Running on Cloudflare
		</p>
	</div>
		...
		<div class="w-full max-w-sm">
			...
			<div class="space-y-3">
				<a
					...
					class="w-full h-12 text-base flex items-center justify-center gap-3 rounded-lg border border-input bg-background px-4 font-medium hover:bg-accent hover:text-accent-foreground transition-colors"
				>
			...
			<p class="text-xs text-center text-muted-foreground mt-8">
