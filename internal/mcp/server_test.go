...
func TestToolsList(t *testing.T) {
	...
	for _, toolI := range tools {
		...
		// taskyou_spotlight was removed — the worktree-sync feature was unused.
		if name == "taskyou_spotlight" {
			t.Error("taskyou_spotlight should no longer be advertised — it was removed")
		}
	}
