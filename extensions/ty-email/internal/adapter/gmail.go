...
func (a *GmailAdapter) getTokenFromWeb(ctx context.Context, config *oauth2.Config) (*oauth2.Token, error) {
	...
	server := &http.Server{Addr: "localhost:8089", ReadHeaderTimeout: 10 * time.Second}
...
func (a *GmailAdapter) fetchMessage(ctx context.Context, id string) (*Email, error) {
	...
	// Detect auto-generated mail for loop protection
	email.AutoReply = isAutoGenerated(func(name string) string {
